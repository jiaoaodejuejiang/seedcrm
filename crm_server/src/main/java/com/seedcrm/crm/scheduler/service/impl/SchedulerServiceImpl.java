...
public class SchedulerServiceImpl implements SchedulerService {
    ...
    public SchedulerJobLog trigger(SchedulerTriggerRequest request) {
        ...
        log.setRetryCount(0);
        log.setPayload(StringUtils.hasText(request.getPayload()) ? request.getPayload().trim() : "{}");
    ...
    private void apply(SchedulerJob job, SchedulerJobUpsertRequest request) {
        ...
        job.setStatus(StringUtils.hasText(request.getStatus()) ? normalize(request.getStatus()) : "ENABLED");
    }
